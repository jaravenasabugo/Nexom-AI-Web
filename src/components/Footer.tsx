      ...
      <div className="max-w-6xl mx-auto">
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 sm:gap-8 mb-8">
          ...
          <div className="text-center sm:text-left">
            <h3 className="text-xl sm:text-2xl font-orbitron font-bold text-white mb-6">
              Contacto
            </h3>
            <div className="space-y-4">
              <div className="flex items-center justify-center sm:justify-start text-gray-300 font-rajdhani hover:text-[#04CFFB] transition-colors">
          ...
          <div className="text-center sm:text-right">
            ...
            <div className="flex justify-center sm:justify-end space-x-4">
              ...
              <a
                ...
                className="w-12 h-12 bg-gradient-to-r from-[#4B32FF] to-[#2784FA] rounded-lg flex items-center justify-center hover:from-[#5027FE] hover:to-[#04CFFB] transition-all duration-300 transform hover:scale-110 min-h-[48px] min-w-[48px]"
              >
